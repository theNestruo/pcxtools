...
void showTitle();
void showUsage();
int readCharset(CharsetProcessor *charsetProcessor, Charset *charset, Bitmap *bitmap, char *pcxFilename);
...
int main(int argc, char **argv) {
    ...
    case MODE_SINGLE_PCX:
        if (verbose) {
            printf("Working mode is: single PCX file.\n");
        }
    ...
    case MODE_MULTIPLE_PCX:
        if (verbose) {
            printf("Working mode is: multiple PCX files.\n");
        }
