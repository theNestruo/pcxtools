[![CI and nightly build](https://github.com/theNestruo/pcxtools/actions/workflows/on-main-push-ci-nightly.yml/badge.svg)](https://github.com/theNestruo/pcxtools/actions/workflows/on-main-push-ci-nightly.yml)
...
* `-ld` lighter (brigther) colors will have higher priority planes

* `-dl` darker colors will have higher priority planes

	These four options allow some control on how the colors get ordered (namely, to avoid the flickering routines make flicker the brigther colors)
...
* [LodePNG](https://lodev.org/lodepng/) &copy; 2005-2025 by Lode Vandevenne.
* Test graphics extracted from the original freeware version of [Ninja Senki](http://ninjasenki.com/) &copy; 2010 Jonathan Lavigne.
* `PNG2SPR+` demo sprites extracted from [Sydney Hunter and the Caverns of Death](http://www.studiopinagames.com/sydney.html) &copy; 2011 Keith Erickson / Studio Pi&ntilde;a
